...
export default function OutSideSection() {
  return (
    <section className="relative w-full max-w-[900px] mx-auto rounded-xl overflow-hidden bg-[#FAFAF0]">
      {/* Image */}
      ...
      <div className="absolute inset-0 flex flex-col justify-end items-center pb-14 text-center px-4">
        <h1 className="text-white text-2xl md:text-4xl font-normal leading-snug">
